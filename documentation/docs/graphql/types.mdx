...
`@eavios/nestjs-query-graphql` provides a number of types. Most will be automatically generated for you when you create a
...
```ts
import { FilterableField, IDField } from '@eavios/nestjs-query-graphql';
...
```ts
import { DeleteManyResponseType } from '@eavios/nestjs-query-graphql';
...
GraphQL implementation of the `@eavios/nestjs-query-core` `Filter` type.
...
```ts
import { FilterType } from '@eavios/nestjs-query-graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
...
```ts
import { UpdateOneInputType } from '@eavios/nestjs-query-graphql';
import { InputType } from '@nestjs/graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
...
```ts
import { CreateOneInputType, FilterType } from '@eavios/nestjs-query-graphql';
import { InputType } from '@nestjs/graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
...
```ts
import { DeleteOneInputType } from '@eavios/nestjs-query-graphql';
import { InputType } from '@nestjs/graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
