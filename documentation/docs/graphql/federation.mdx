...
import { Connection } from '@eavios/nestjs-query-graphql';
import { ObjectType, Directive, Field, ID } from '@nestjs/graphql';
import { SubTaskDTO } from './sub-task.dto';
...
import { FederationResolver } from '@eavios/nestjs-query-graphql';
import { Resolver } from '@nestjs/graphql';
import { TodoItemReferenceDTO } from './todo-item-reference.dto';
import { TodoItemService } from './todo-item.service';
...
To see a complete example checkout https://github.com/eavios/nestjs-query/tree/master/examples/federation
