...
The core of `nestjs-query` is the `Query`, it is used by `@eavios/nestjs-query-graphql`, `@eavios/nestjs-query-typeorm`
`@eavios/nestjs-query-sequelize`, `@eavios/nestjs-query-mongoose` and `@eavios/nestjs-query-typegoose`.
...
sets. For more info see this [issue](https://github.com/eavios/nestjs-query/issues/954)
