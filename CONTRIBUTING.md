...
We use [github issues](https://github.com/eavios/nestjs-query/issues) and [pull requests](https://github.com/eavios/nestjs-query/pulls) to track all bugs and feature. All changes should be reflected in an issue or pull request.
...
* Add your example to the `examples/nest-cli.json` `projects` array.
  * If your example requires `typeorm` or `sequelize` add your init scripts to:
    * `examples/init-scripts/mysql` - See the [basic example](https://github.com/eavios/nestjs-query/blob/master/examples/init-scripts/mysql/init-basic.sql)
    * `examples/init-scripts/postgres` - See the [basic example](https://github.com/eavios/nestjs-query/blob/master/examples/init-scripts/postgres/init-basic.sql)
  * All files should match the following format `init-{example-name}.sql`
    ...
    * Be sure to use the user you created in your `app.module.ts` file. See [the basic example](https://github.com/eavios/nestjs-query/blob/master/examples/basic/src/app.module.ts) 
