...
The `@eavios/nestjs-query-graphql` package includes an `@Authorize` decorator that allows you to add additional filter
...
import { FilterableField, IDField, FilterableRelation, Authorize } from '@eavios/nestjs-query-graphql';
...
import { Authorize, FilterableField, IDField, FilterableRelation } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { TodoItemDTO } from '../../todo-item/dto/todo-item.dto';
import { UserDTO } from '../../user/user.dto';
...
import { Filter, InjectQueryService, mergeFilter, mergeQuery, QueryService } from '@eavios/nestjs-query-core';
import { AuthorizerInterceptor, AuthorizerFilter, ConnectionType } from '@eavios/nestjs-query-graphql';
...
import { QueryService, InjectQueryService } from '@eavios/nestjs-query-core';
import { CRUDResolver, InjectAuthorizer } from '@eavios/nestjs-query-graphql';
...
```ts title='sub-task/sub-task.authorizer.ts'
import { Injectable } from '@nestjs/common';
import { CustomAuthorizer } from '@eavios/nestjs-query-graphql';
import { Filter } from '@eavios/nestjs-query-core';
import { UserContext } from '../auth/auth.interfaces';
import { SubTaskDTO } from './dto/sub-task.dto';
...
You can find a complete example in [`examples/auth`](https://github.com/eavios/nestjs-query/tree/master/examples/auth)
