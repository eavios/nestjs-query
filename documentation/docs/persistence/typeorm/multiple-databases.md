...
Therefore, `@eavios/nestjs-query-typeorm` also offers this functionality. This section will walk you through a short example indicating how to connect your application to multiple databases. Further, this will assume, that you **already have a working application with a configured database**. Please note that only key aspects are shown here:
...
For a full example see the [examples](https://github.com/eavios/nestjs-query/tree/master/examples/typeorm-multidb).
