...
import { UpdateManyResponse, Filter } from '@eavios/nestjs-query-core';
import { CRUDResolver, FilterType, UpdateManyResponseType } from '@eavios/nestjs-query-graphql';
...
To see a complete example [see here.](https://github.com/eavios/nestjs-query/tree/master/examples/typeorm-soft-delete)
