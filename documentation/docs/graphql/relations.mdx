...
`@eavios/nestjs-query-graphql` will then automatically create the following graphql definition:
...
```ts title="sub-task/sub-task.dto.ts" {6}
import { FilterableField, IDField, FilterableRelation } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { TodoItemDTO } from '../todo-item/todo-item.dto.ts';
...
import { FilterableField, IDField, UnPagedRelation } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
...
```ts title="sub-task/sub-task.dto.ts" {6}
import { FilterableField, IDField, FilterableUnPagedRelation } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, OffsetConnection } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
import { FilterableField, IDField, FilterableOffsetConnection, QueryOptions } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.module.ts"
import { PagingStrategies } from '@eavios/nestjs-query-core';
import { NestjsQueryGraphQLModule } from '@eavios/nestjs-query-graphql';
import { NestjsQueryTypeOrmModule } from '@eavios/nestjs-query-typeorm';
import { Module } from '@nestjs/common';
import { TodoItemDTO } from './todo-item.dto';
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, CursorConnection } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, Connection } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
```ts title="todo-item/todo-item.dto.ts" {6}
import { FilterableField, IDField, FilterableCursorConnection } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime } from '@nestjs/graphql';
import { SubTaskDTO } from '../sub-task/sub-task.dto'
...
import { ReadResolver, Relatable } from '@eavios/nestjs-query-graphql';
