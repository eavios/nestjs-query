...
This method leverages the `transformQuery` function from `@eavios/nestjs-query-core`. This method will remap all fields specified in the field map to correct field name.
