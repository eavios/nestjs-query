...
```ts {7-10}
import { FilterableField, BeforeCreateOne, CreateOneInputType } from '@eavios/nestjs-query-graphql';
...
import { BeforeCreateOneHook, CreateOneInputType,} from '@eavios/nestjs-query-graphql';
...
```ts {6}
import { FilterableField, BeforeCreateOne } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
...
```ts {7-11}
import { FilterableField, BeforeCreateMany, CreateManyInputType } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { GqlContext } from '../../interfaces';
import { getUserName } from '../../helpers';
...
```ts
import { Injectable } from '@nestjs/common';
import { BeforeCreateManyHook, CreateManyInputType,} from '@eavios/nestjs-query-graphql';
import { GqlContext } from './auth/auth.guard';
import { AuthService } from './auth/auth.service';
...
```ts {6}
import { FilterableField, BeforeCreateMany } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { CreatedByHook } from '../../hooks';
...
```ts {7-10}
import { FilterableField, BeforeUpdateOne, UpdateOneInputType } from '@eavios/nestjs-query-graphql';
...
```ts
import { BeforeUpdateOneHook, UpdateOneInputType } from '@eavios/nestjs-query-graphql';
import { Injectable } from '@nestjs/common';
import { GqlContext } from './auth/auth.guard';
import { AuthService } from './auth/auth.service';
...
```ts {6}
import { FilterableField, BeforeUpdateOne } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { CreatedByHook } from '../../hooks';
...
```ts {7-10}
import { FilterableField, BeforeUpdateMany, UpdateManyInputType } from '@eavios/nestjs-query-graphql';
import { ObjectType } from '@nestjs/graphql';
import { GqlContext } from '../../interfaces';
import { getUserName } from '../../helpers';
...
In this example we create a simple Hook that works with any type that has a `updatedBy` property.
```ts
import { BeforeUpdateManyHook, UpdateManyInputType } from '@eavios/nestjs-query-graphql';
import { Injectable } from '@nestjs/common';
import { GqlContext } from './auth/auth.guard';
import { AuthService } from './auth/auth.service';
...
```ts {6}
import { FilterableField, BeforeUpdateMany } from '@eavios/nestjs-query-graphql';
import { ObjectType, ID, GraphQLISODateTime, Field } from '@nestjs/graphql';
import { CreatedByHook } from '../../hooks';
...
import { HookTypes, HookInterceptor, MutationHookArgs, UpdateManyResponseType } from '@eavios/nestjs-query-graphql';
